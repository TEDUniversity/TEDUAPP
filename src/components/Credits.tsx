                                                        ...
                                                        >
                                                                      ...
                                                                      <View style={styles.socialContainer} >
                                                                                    ...
                                                                                    <Image
                                                                                                  onPress={() => {
                                                                                                                this.props.navigation.navigate("WebviewRouter", {
                                                                                                                              url: "https://tr.linkedin.com/edu/ted-%C3%BCniversitesi-23068",
                                                                                                                              title: "TEDU Linkedin",
                                                                                                                              backButton: "Menu"
                                                                                                                });
                                                                                                  }}
                                                                      ...
                                                                      <View style={styles.developerContainer} >
                                                                                    <View style={styles.developerSubContainer} >
                                                                                                  <Text style={styles.developerName}>Arda Tümay / IOS Developer</Text>
                                                                                                  <Text style={styles.developerMail}>arda.tumay@tedu.edu.tr </Text>
                                                                                    </View>
                                                                                    <View style={[styles.developerSubContainer, { marginTop: deviceWidth / 18.75 }]}>
                                                                                                  <Text style={styles.developerName}>Hayri Durmaz / Android Developer</Text>
                                                                                                  <Text style={styles.developerMail}>hayri.durmaz@tedu.edu.tr </Text>
                                                                                    </View>
